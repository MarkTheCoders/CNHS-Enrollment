...
<!-- Font--->
	...
	<body>
		...
		<section id="menu">
			...
			<div class="sidebar">
				<li><i class="fa-solid fa-home"></i><a href="../Grade10.php" >Grade 10</a></li>
				<li style="border-bottom: 4px solid green;"><i class="fa-solid fa-database"></i><a href="section1.php">Section1</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="../delete4/Delete.php?id=<?php echo $row['student_id']?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
