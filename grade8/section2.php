	...
	<body>
		...
		<section id="menu">
			...
			<div class="sidebar">
				...
				<li style="border-bottom: 4px solid green;"><i class="fa-solid fa-database"></i><a href="section2.php">Section 2</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="../delete3/Delete2.php?id=<?php echo $row['student_id']?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
