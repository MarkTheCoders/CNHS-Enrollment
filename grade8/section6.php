	...
	<body>
		...
		<section id="menu">
			...
			<div class="sidebar">
				...
				<li style="border-bottom: 4px solid green;"><i class="fa-solid fa-database"></i><a href="section6.php">Section 6</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="../delete3/Delete6.php?id=<?php echo $row['student_id']?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
