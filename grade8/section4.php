	...
	<body>
		...
		<section id="menu">
			...
			<div class="sidebar">
				...
				<li><i class="fa-solid fa-database"></i><a href="section3.php">Section 3</a></li>
				<li style="border-bottom: 4px solid green;"><i class="fa-solid fa-database"></i><a href="section4.php">Section 4</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="../delete3/Delete4.php?id=<?php echo $row['student_id']?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
