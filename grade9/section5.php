...
<!-- Font--->
	...
	<body>
		...
		<section id="menu">
			...
			<div class="sidebar">
				<li><i class="fa-solid fa-home"></i><a href="../Grade9.php" >Grade 9</a></li>
				
			
				<li><i class="fa-solid fa-database"></i><a href="section4.php">Section 4</a></li>
				<li  style="border-bottom: 4px solid green;"><i class="fa-solid fa-database"></i><a href="section5.php">Section 5</a></li>
				
				<li><i class="fa-solid fa-database"></i><a href="section6.php">Section 6</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="../delete2/Delete5.php?id=<?php echo $row['student_id']?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
